...
using Administration = Bud2b.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Bud2b.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
...
[assembly: NavigationLink(9000, "Administration/Tenants", typeof(Bud2b.Default.Pages.TenantsController), icon: "icon-people")]