...
(function (Bud2b) {
    ...
    })(Administration = Bud2b.Administration || (Bud2b.Administration = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Administration;
    (function (Administration) {
        ...
        (function (LanguageRow) {
            ...
            ['Id', 'LanguageId', 'LanguageName', 'TenantId'].forEach(function (x) { return Fields[x] = x; });
...
(function (Bud2b) {
    ...
    })(Common = Bud2b.Common || (Bud2b.Common = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Common;
...
(function (Bud2b) {
    ...
    })(Default = Bud2b.Default || (Bud2b.Default = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Default;
...
(function (Bud2b) {
    ...
    })(Meeting = Bud2b.Meeting || (Bud2b.Meeting = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Meeting;
...
(function (Bud2b) {
    ...
    (function (Meeting) {
        ...
        (function (MeetingAgendaTypeRow) {
            ...
            ['AgendaTypeId', 'Name', 'TenantId'].forEach(function (x) { return Fields[x] = x; });
...
(function (Bud2b) {
    ...
    (function (Meeting) {
        ...
        (function (MeetingLocationRow) {
            ...
            ['LocationId', 'Name', 'Address', 'Latitude', 'Longitude', 'TenantId'].forEach(function (x) { return Fields[x] = x; });
...
(function (Bud2b) {
    ...
    })(Membership = Bud2b.Membership || (Bud2b.Membership = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Membership;
...
(function (Bud2b) {
    ...
    })(Organization = Bud2b.Organization || (Bud2b.Organization = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Organization;
    (function (Organization) {
        ...
        (function (BusinessUnitRow) {
            ...
            ['UnitId', 'Name', 'ParentUnitId', 'ParentUnitName', 'ParentUnitParentUnitId', 'TenantId'].forEach(function (x) { return Fields[x] = x; });
...
(function (Bud2b) {
    ...
    })(Authorization = Bud2b.Authorization || (Bud2b.Authorization = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Administration;
    (function (Administration) {
        var UserDialog = (function (_super) {
            ...
            UserDialog.prototype.getPropertyItems = function () {
                ...
                if (!Bud2b.Authorization.hasPermission("Administration:Tenants"))
...
(function (Bud2b) {
    ...
    Bud2b.BasicProgressDialog = BasicProgressDialog;
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Bud2b.BasicProgressDialog();
...
(function (Bud2b) {
    ...
    })(DialogUtils = Bud2b.DialogUtils || (Bud2b.DialogUtils = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Common;
...
(function (Bud2b) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Bud2b.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Bud2b.LanguageList || (Bud2b.LanguageList = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Common;
...
(function (Bud2b) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Bud2b.LanguageList.getValue;
    })(ScriptInitialization = Bud2b.ScriptInitialization || (Bud2b.ScriptInitialization = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
    var Common;
...
(function (Bud2b) {
    var Default;
    (function (Default) {
        var TenantsEditor = (function (_super) {
            __extends(TenantsEditor, _super);
            function TenantsEditor(container) {
                return _super.call(this, container) || this;
            }
            TenantsEditor.prototype.getColumnsKey = function () { return 'Default.Tenants'; };
            TenantsEditor.prototype.getDialogType = function () { return Default.TenantsEditorDialog; };
            TenantsEditor.prototype.getLocalTextPrefix = function () { return Default.TenantsRow.localTextPrefix; };
            return TenantsEditor;
        }(Bud2b.Common.GridEditorBase));
        TenantsEditor = __decorate([
            Serenity.Decorators.registerClass()
        ], TenantsEditor);
        Default.TenantsEditor = TenantsEditor;
    })(Default = Bud2b.Default || (Bud2b.Default = {}));
})(Bud2b || (Bud2b = {}));
...
(function (Bud2b) {
    var Default;
    (function (Default) {
        var TenantsEditorDialog = (function (_super) {
            __extends(TenantsEditorDialog, _super);
            function TenantsEditorDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.TenantsForm(_this.idPrefix);
                return _this;
            }
            TenantsEditorDialog.prototype.getFormKey = function () { return Default.TenantsForm.formKey; };
            TenantsEditorDialog.prototype.getLocalTextPrefix = function () { return Default.TenantsRow.localTextPrefix; };
            TenantsEditorDialog.prototype.getNameProperty = function () { return Default.TenantsRow.nameProperty; };
            return TenantsEditorDialog;
        }(Bud2b.Common.GridEditorDialog));
        TenantsEditorDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], TenantsEditorDialog);
        Default.TenantsEditorDialog = TenantsEditorDialog;
    })(Default = Bud2b.Default || (Bud2b.Default = {}));
})(Bud2b || (Bud2b = {}));
var Bud2b;
(function (Bud2b) {
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Bud2b.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Bud2b.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
...
//# sourceMappingURL=Bud2b.Web.js.map