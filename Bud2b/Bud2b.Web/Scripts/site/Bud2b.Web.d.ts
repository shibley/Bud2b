...
declare namespace Bud2b.Administration {
}
declare namespace Bud2b.Administration {
...
declare namespace Bud2b.Common.Pages {
...
declare namespace Bud2b.Common {
...
declare namespace Bud2b.Default {
}
declare namespace Bud2b.Default {
...
declare namespace Bud2b.Meeting {
}
declare namespace Bud2b.Meeting {
...
declare namespace Bud2b.Membership {
...
declare namespace Bud2b.Organization {
}
declare namespace Bud2b.Organization {
...
declare namespace Bud2b.Authorization {
...
declare namespace Bud2b.DialogUtils {
...
declare namespace Bud2b.LanguageList {
...
declare namespace Bud2b.ScriptInitialization {
}
declare namespace Bud2b.Common {
...
declare namespace Bud2b.Default {
    class TenantsEditor extends Common.GridEditorBase<TenantsRow> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof TenantsEditorDialog;
        protected getLocalTextPrefix(): string;
        constructor(container: JQuery);
    }
}
declare namespace Bud2b.Default {
    class TenantsEditorDialog extends Common.GridEditorDialog<TenantsRow> {
        protected getFormKey(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected form: TenantsForm;
